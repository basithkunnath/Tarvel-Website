...
class view_all_packages(models.Model):
    ...
    features = models.JSONField(default=list, help_text="Enter features as a list.")
...
class ItineraryItem(models.Model):
    package = models.ForeignKey(view_all_packages, on_delete=models.CASCADE, related_name='itinerary_items')
